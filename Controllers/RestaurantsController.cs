...
namespace Restaurants_API.Controllers
{
    ...
    {
        private readonly Restaurants_APIContext _context;

        public RestaurantsController(Restaurants_APIContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Restaurant>> PostRestaurant(Restaurant restaurant)
        {
            ...
            return CreatedAtAction("GetRestaurant", new { id = restaurant.Restaurant_ID }, restaurant);
        }
